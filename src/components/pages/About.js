  ...
  return (
    <main className="w-3/4 pt-20 m-auto flex flex-row">
      <aside className="m-auto p-10">
        <img src={profileImage} alt="Helen Lee head shot" class="photo" />
      </aside>
      <section>
          <h1>Hi, I'm Helen Lee</h1>

          <p> I am a full stack developer based in Perth Australia and have completed the UWA Full Stack Developer Bootcamp course. 
