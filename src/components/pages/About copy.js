  ...
  return (
    <main className="m-auto flex flex-row">
      ...
      <section className="w-2/4 pt-20 pl-20">
          ...
          {/* <p className="mb-10 text-orange-800 hand-written text-3xl stext"> Would love to hear from you if you have an opportunity for me!!.     </p> */}
          <p className="mb-10 text-orange-800 hand-written text-3xl size-animation"> Would love to hear from you if you have an opportunity for me!!.</p>
          {/* <p className="mb-10 text-orange-800 hand-written text-3xl stext"> if you have an opportunity for me!!.     </p> */}
