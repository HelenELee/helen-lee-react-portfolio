  ...
  return (
    <main className="w-3/4 pt-20 m-auto flex flex-col justify-center">
      <div className="flex flex-col justify-center">
        <span className="text-center about-me text-xl highlight text-4xl">Below is a snapshot of my skills. <br></br>Please check out my <a href="https://github.com/HelenELee" className="hover:curser-grabbing hover:underline">GitHub</a> account to see how I have used them.</span>
